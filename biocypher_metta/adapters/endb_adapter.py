...
class ENdbAdapter(Adapter):
    ...
    ALLOWED_LABELS = ['regulate']
    INDEX = {'enhancer_id': 0, 'pubmed': 1,  'chr': 4, 'coord_start': 5, 'coord_end': 6, 'species' : 7, 'enhancer_type': 12, 'gene_id': 13, 'strong_experiment': 14, 'disease': 18, 'tf_name': 24}
    ...
    def handle_target_genes(self, genes):
        ...
        if not result and genes:
            result.append(genes[0])
    ...
    def get_nodes(self):
        ...
        with gzip.open(self.filepath, 'rt') as f:
            ...
            for line in f:
                ...
                chromosome = data[ENdbAdapter.INDEX['chr']]
                start_position = int(data[ENdbAdapter.INDEX['coord_start']])
                end_position = int(data[ENdbAdapter.INDEX['coord_end']])
